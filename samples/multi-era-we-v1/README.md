# Multi-era pack: `we-multi-era-v1`

Western Europe multi-era geometry + politics v1

## Eras

| Era | Scenario | Geometry pack | Geometry | Politics |
| --- | --- | --- | --- | --- |
| 1444 | `official-1444` | `we-1444-v1` | `period-geometry` | `curated-politics` |
| 1836 | `official-1836` | `we-1836-v1` | `period-geometry` | `curated-politics` |
| 1936 | `official-1936` | `we-1936-v1` | `period-geometry` | `curated-politics` |
...
- Paradox-grade completeness for any single era
