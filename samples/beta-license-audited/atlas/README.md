...
| Path | Purpose |
| --- | --- |
| `ownership_choropleth.geojson` | Province polygons with owner/controller/culture/religion + color fields |
...
Culture and religion paint use curated scenario hints. Unassigned provinces are gray (`#8a8a8a`). Prefer `['get','culture_color']` fill over large match expressions for full-world packs.
