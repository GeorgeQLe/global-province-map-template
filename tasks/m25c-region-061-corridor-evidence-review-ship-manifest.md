# M25C region 061 evidence-review ship manifest

## User goal

Review region `061` (American Samoa western–eastern districts) on the frozen Task 16 baseline without mutating evidence inputs.

## Changed files

- `tasks/m25c-region-061-corridor-evidence-review.md`
- `tasks/m25c-region-061-corridor-evidence-review-ship-manifest.md`
- `tasks/todo.md`
- `tasks/history.md`

## User-goal mapping

Disposition: **rejected**. Topology has zero cross-actor pairs, but the record reason is inconsistent and seven Tokelau components carry region-053 actor/source contamination that the region generator cannot reproduce. The review rejects implementation and preserves every input and permission.
...
The fifth-wave cross-review challenged every disposition for inconsistent measurements, omitted adjacency pairs, modern dispatch, candidate-derived geometry, source contamination, and permission drift. Region `061` retained the disposition recorded above.
