...
| M25C | in progress; 22 of 22 regions compositionally migrated | compositional seam QA and nine Natural Earth 5.1.1 modern controls now supplement the five-facet/typed-relationship model; runtime and publication guards remain unchanged | nine deterministic inland seams execute at 75 km / 0.20; 021 and 029 pass, seven fail with component inventories; missing-negative regions fall from 19 to 10 | the circular region-015 frontier is retired and all nine Americas/Africa positive-border requirements remain fail-closed | remediate the seven reviewer-gated historical status leaks later; next research Asia/Europe assertions without weakening current failures |
