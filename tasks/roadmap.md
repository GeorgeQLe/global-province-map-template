...
| M25C | in progress; replacement evidence obtained but unsigned; assembled candidate remains ordinary-QA blocked | shared final-artifact qualifier, transactional `assembled-pass` generation, covered-zero seam observability, exact hash-bound region 057 approval, pinned Cliopatria 1444 slice, eight direct-border candidates, ten applicability audits, 18 corridor dossiers | evidence packet accounts for all 56 errors exactly once; frozen candidate still has 56 non-review blockers plus one warning | `1.0.0-assembled.1` certification-review candidate; all review/certification/runtime/public permissions false | independently decide and serially implement only approved evidence; only zero-error preflight may open Task 17 |
