...
| M25C | in progress; 2 of 22 regions promoted | accepted refrozen census and M23/M49 inputs; deterministic provisional generator; regions 154 and 155 four-layer Grade-A packets; schema 0.3 provisional QA plus unchanged certification gates | exact 23,582-location/22,000-province/88-row checks, region-154/155 source-pin, asset, spatial, and render gates; provisional QA and non-promotion tests | provisional path remains non-public and non-certifiable; 20 regions and 80 Grade-A rows remain | promote region 151 next, then complete the remaining exact-date packets before ordinary research QA, human review, runtime certification, and publication |
