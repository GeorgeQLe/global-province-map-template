...
| M25C | in progress; non-public worldwide provisional pass complete | accepted census and M23/M49 inputs; deterministic provisional generator; regional evidence packets; schema 0.3 provisional QA plus unchanged certification gates | exact 23,582-location/22,000-province/88-row checks, duplicate 288 MB builds, provisional pre/post-render QA, 361-test suite, non-promotion tests | provisional path remains non-public and non-certifiable; v2 pilot/anomaly evidence retained; no Grade-A claim made | promote all 22 regions with exact-date four-layer packets, then run ordinary research QA, human review, runtime certification, and publication |
