...
| M25C | in progress; 17 of 22 regions promoted | accepted refrozen census and M23/M49 inputs; deterministic provisional generator; regions 005, 011, 013, 014, 015, 017, 021, 029, 030, 034, 035, 039, 143, 145, 151, 154, and 155 four-layer Grade-A packets; schema 0.3 provisional QA plus unchanged certification gates | exact 23,582-location/22,000-province/88-row checks, regional source-pin, asset, spatial, and render gates; provisional QA and non-promotion tests | provisional path remains non-public and non-certifiable; 5 regions and 20 Grade-A rows remain | promote Southern Africa and the remaining Oceania regions in risk-first order before ordinary research QA, human review, runtime certification, and publication |
