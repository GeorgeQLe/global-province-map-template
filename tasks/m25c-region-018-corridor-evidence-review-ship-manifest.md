# M25C region 018 evidence-review ship manifest

## User goal

Review region `018` (Botswana–South Africa) on the frozen Task 16 baseline without mutating evidence inputs.

## Changed files

- `tasks/m25c-region-018-corridor-evidence-review.md`
- `tasks/m25c-region-018-corridor-evidence-review-ship-manifest.md`
- `tasks/todo.md`
- `tasks/history.md`

## User-goal mapping

Disposition: **rejected**. Natural Earth ADM0_A3 dispatch chooses Botswana and South Africa actor sheets; the current packet has no exact-date two-sided geometry or exhaustive component mapping. The review rejects implementation and preserves every input and permission.
...
The fifth-wave cross-review challenged every disposition for inconsistent measurements, omitted adjacency pairs, modern dispatch, candidate-derived geometry, source contamination, and permission drift. Region `018` retained the disposition recorded above.
