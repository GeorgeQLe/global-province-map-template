...
- M25C regional evidence promotion: replace provisional records in risk-first
  order (`039, 145, 015`, then Asia, Africa/Americas, and Oceania)
  with dated, source-pinned four-layer packets. Regions `151`, `154`, and `155`
  are complete; 19 regions and 76 rows remain. Only after all 88 rows are gap-free Grade A may
