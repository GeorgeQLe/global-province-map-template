# M25C region 017 evidence-review ship manifest

## User goal

Review region `017` (Angola–DRC) on the frozen Task 16 baseline without mutating evidence inputs.

## Changed files

- `tasks/m25c-region-017-corridor-evidence-review.md`
- `tasks/m25c-region-017-corridor-evidence-review-ship-manifest.md`
- `tasks/todo.md`
- `tasks/history.md`

## User-goal mapping

Disposition: **rejected**. Natural Earth ADM0_A3 dispatch chooses the corridor actors; 37 affected components have only partial eligible coverage and no independent historical spatial mapping. The review rejects implementation and preserves every input and permission.
...
The fifth-wave cross-review challenged every disposition for inconsistent measurements, omitted adjacency pairs, modern dispatch, candidate-derived geometry, source contamination, and permission drift. Region `017` retained the disposition recorded above.
